...
// â”€â”€ CONFIGURACIÃ“N DE CHAMBEADORES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async function revealChambeador(type) {
  // En una implementaciÃ³n real, esto actualizarÃ­a Firestore para mostrar el chambeador
  console.log(`Revelando chambeador del ${type}`);
  // AquÃ­ se podrÃ­a agregar un log de novedad
}

async function hideChambeador(type) {
  // En una implementaciÃ³n real, esto actualizarÃ­a Firestore para ocultar el chambeador
...
window.renderEvolutionPts = () => {
  ...
  const labels = isDayView
    ...
    : Array.from({length: count}, (_, i) => `DÃ­a ${i+1}`);
  ...
  const series = team.map((m) => {
    ...
    // Calcular puntos iniciales antes del perÃ­odo
  ...
  if (mode === "line") {
    ...
    // Modo columnas: UNA barra por usuario en cada perÃ­odo
    // Compactar si hay muchos usuarios permitiendo scroll o agrupaciÃ³n
    const maxVisibleBars = 12; // MÃ¡ximo de usuarios visibles sin scroll
